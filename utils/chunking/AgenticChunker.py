...
class AgenticChunker:
    ...
    def _find_relevant_chunk(self, proposition):
        ...
        # Ensure chunk_found is a string
        if not isinstance(chunk_found, str):
            chunk_found = str(chunk_found)
        ...
        try:
            ...
            parsed_response = parser.parse(chunk_found)
            ...
            chunk_id_match = re.search(pattern, chunk_found)
            chunk_found = chunk_id_match.group(0) if chunk_id_match else None

        # If you got a response that isn't the chunk id length, chances are it's a bad response or it found nothing
        # So return nothing
